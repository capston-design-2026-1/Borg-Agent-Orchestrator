...
def test_trace_rows_to_training_matrices_shapes():
    ...
    assert matrices.y_risk.tolist() == [0, 0, 0, 0]
    assert [round(value, 2) for value in matrices.y_demand.tolist()] == [0.7, 0.35, 0.7, 0.35]
...
def test_trace_rows_to_training_matrices_normalizes_aiopslab_state_shapes():
    ...
    assert [round(value, 2) for value in matrices.y_demand.tolist()] == [0.6, 0.35, 0.6, 0.35]
...
def test_trace_rows_to_training_matrices_accepts_flat_metric_rows():
    ...
    assert [round(value, 2) for value in matrices.y_demand.tolist()] == [0.95, 0.45, 0.95, 0.45]
