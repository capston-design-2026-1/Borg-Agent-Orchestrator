...
| Control pressure timelines | Four separate rolling five-minute graph widgets: Safety Forecast, Admission Backlog, Efficiency Energy, and Reward Outcome. They keep unrelated scales out of the same canvas while preserving the objective signals the experimental architecture optimizes. |
